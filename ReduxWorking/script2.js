...
setTimeout(() => {
  store.dispatch({ type: AGE_INCREMENT_BY, payload: 100 }); // {count: 0, company: 'adobe', age: 131}
}, 2000);
decAgeButton.addEventListener("click", () => {
  store.dispatch({ type: AGE_DECREMENT_BY, payload: 5 }); // {count: 0, company: 'adobe', age: 126}
});
